...
# Salvar o DataFrame atualizado de volta para o arquivo CSV na pasta desejada
try:
    df.to_csv('C:\\SysBroken\\api\\acoes_atualizadas.csv', index=False)
    print("Dados atualizados e salvos no arquivo 'C:\\SysBroken\\api\\acoes_atualizadas.csv'")
except Exception as e:
